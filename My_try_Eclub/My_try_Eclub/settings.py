"""
Django settings for My_try_Eclub project.
...
SECRET_KEY = 'django-insecure-!(iasqzu5#3cf1^e)8=n+7wbh9zj7#$62jvn^ujxg@=sl-gl_y'
...
ROOT_URLCONF = 'My_try_Eclub.urls'
...
WSGI_APPLICATION = 'My_try_Eclub.wsgi.application'
